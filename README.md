...
| WAV | WSJT-X | rs-ft8n WASM (subtract) | 比較ポイント |
|-----|--------|------------------------|-------------|
| `sim_busy_band.wav` | 7 局 | **16 局** | OSD 深度の差 |
| `sim_stress_fullband.wav` | 10 局 (target missed) | **15 局 (target missed)** | ADC 飽和で target 消失（双方） |
| **`sim_stress_bpf_edge_clean.wav`** | **デコード不能** | **CQ 3Y0Z JD34 (197 ms)** | **rs-ft8n の勝利** |
